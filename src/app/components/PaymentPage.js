    ...
    <>
      {loading ? (
        ...
        <>
          ...
          <ToastContainer />
          <div className="cover w-full relative mt-12">
            <img
            ...
            {currentUser.project ? (
              <div className="container  font-bold flex flex-col gap-2 bg-slate-900 p-5 mt-5 bg-rgb(0 9 29) rounded-xl w-[70vw]">
                <div className=" m-auto">
                  {" "}
                  Project : {currentUser.project || `! No Active Project`}{" "}
                  <Link
                ...
                <div className=" m-auto">
                  Project Description: {currentUser.projectDescription}
                </div>
              </div>
            ) : (
                  ...
                  {payments.slice(0, 7).map((p, i) => {
                    return (
                      <li key={i} className="my-2 flex gap-2 item-center">
                        ...
                        <span>
                          {p.name}{" "}
                          <span className="font-bold">₹{p.amount}</span>. Here
                          is the message "{p.message}"
                        </span>
                      </li>
                    );
                  })}
                ...
                <div className="flex w-[100%] gap-5 md:gap-2 flex-col z-20">
                  ...
                  <div className="flex justify-center items-center">
                    <RainbowButton
                      ...
                      className="text-white w-48 hover:w-[70%]  font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 transition-all ease-in-out"
                    >
                      Pay
                    </RainbowButton>
                  </div>
